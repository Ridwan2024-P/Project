...
$articulate_score=(int)$data['articulate'];
$tools_score=(int)$data['tools'];
 $presentation_score=(int)$data['presentation'];

        $teamwork_score = (int)$data['teamwork'];
    ...
    private function updateGroupAverage($group_number, $group_members, $project_title)
    {
        ...
        $average = round($avg_result['avg_total']/4, 2);
        $avg_query->close();
